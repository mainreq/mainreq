...
def orderingList(model):
    if model == UserType:
        return [
            {'order':'identifier', 'label':'identificador', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':15,},
            {'order':'name', 'label':'nombre', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':9,},
        ]
    elif model == UserRequirement:
        return [
            {'order':'identifier', 'label':'identificador', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':15,},
            {'order':'name', 'label':'nombre', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':9,},
            {'order':'state', 'label':'estado', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':12,},
            {'order':'-cost', 'label':'costo', 'up':'&#x25BF;', 'down':'&#x25B5;', 'width':8,},
            {'order':'priority', 'label':'prioridad', 'up':'&#x25BF;', 'down':'&#x25B5;', 'width':13,},
            {'order':'reqType', 'label':'tipo', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':18,},
            {'order':'increment', 'label':'hito', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':10,},
        ]
        ...
        return [
            ...
            {'order':'priority', 'label':'prioridad', 'up':'&#x25BF;', 'down':'&#x25B5;', 'width':13,},
            {'order':'reqType', 'label':'tipo', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':18,},
            {'order':'increment', 'label':'hito', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':15,},
        ]
    elif model == Module:
        return [
            {'order':'identifier', 'label':'identificador', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':15,},
            {'order':'name', 'label':'nombre', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':44,},
            {'order':'-cost', 'label':'costo', 'up':'&#x25BF;', 'down':'&#x25B5;', 'width':8,},
            {'order':'priority', 'label':'prioridad', 'up':'&#x25BF;', 'down':'&#x25B5;', 'width':10,},
        ]
    elif model == TestCase:
        return [
            {'order':'identifier', 'label':'identificador', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':15,},
            {'order':'name', 'label':'nombre', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':9,},
            {'order':'state', 'label':'estado', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':20,},
            {'order':'requirement', 'label':'requisito', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':10,},
        ]
        ...
        return [
            {'order':'state', 'label':'estado', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':55,},
            {'order':'deadlineDate', 'label':'revisión', 'up':'&#x25B5;', 'down':'&#x25BF;', 'width':9,},
        ]
    return []
